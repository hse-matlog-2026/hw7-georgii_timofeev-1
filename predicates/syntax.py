...
class Term:
    ...
    def __repr__(self) -> str:
        ...
        if is_function(self.root):
            return self.root + "(" + ",".join(repr(term) for term in self.arguments) + ")"
        ...
        if is_function(string[0]):
            ...
            while True:
                ...
                if remainder[0] == ")":
                    ...
                    break
                remainder = remainder[1:]
            return Term(name, terms), remainder
...
class Formula:
    ...
    def _parse_prefix(string: str) -> Tuple[Formula, str]:
        ...
        if is_quantifier(string[0]):
            ...
            return Formula(quant, var, statement), remainder[1:]
            ...
            if remainder[0] != ")":
                while True:
                    ...
                    if remainder[0] == ")":
                        break
                    remainder = remainder[1:]
            return Formula(name, terms), remainder[1:]
        else:
